...
== == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == ==
    = grading_b_plus_tree_checkpoint_2_concurrent_test
    : /
      autograder / bustub / src / storage / index /
      b_plus_tree
          .cpp : 48 : bustub::BPlusTree<KeyType, ValueType, KeyComparator>::BPlusTree(
                          std::__cxx11::string, bustub::BufferPoolManager *, const KeyComparator &, int,
                          int)[with KeyType = bustub::GenericKey<8>; ValueType = bustub::RID;
                               KeyComparator = bustub::GenericComparator<8>;
                               std::__cxx11::string = std::__cxx11::basic_string<char>]
    : Assertion `false' failed. test_BPlusTree_ConcurrentDeleteTest2(__main__.TestProject2)(0.0 / 5.0) Test Failed
    : False is not true : Test[BPlusTreeConcurrentTest.DeleteTest2] failed
          .Running main() from gmock_main.cc[== == == == == ] Running 7 tests from 1 test suite.[----------] Global test
                              environment set -
